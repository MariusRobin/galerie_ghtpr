...
{
    /**
     * @var \Ghtpr\GalerieGhtpr\Domain\Model\Album
     */
    ...
    {
        parent::setUp();
        $this->subject = new \Ghtpr\GalerieGhtpr\Domain\Model\Album();
    }
     ...
     * @test
     */
    public function getPublishedDateReturnsInitialValueForDateTime()
    {
        self::assertEquals(
            null,
            $this->subject->getPublishedDate()
        );
    }
     ...
     * @test
     */
    public function setPublishedDateForDateTimeSetsPublishedDate()
    {
        $dateTimeFixture = new \DateTime();
        $this->subject->setPublishedDate($dateTimeFixture);
    ...
    {
        $image = new \Ghtpr\GalerieGhtpr\Domain\Model\Image();
